...
local bg_darker      = '#001100'
local bg_dark        = '#000000'
local bg             = '#001100'
local bg_light       = '#001100'
local bg_lighter     = '#005500'
local grey           = '#00bb00'
local red            = '#00bb00'
local heavy_red      = '#00bb00'
local green          = '#00bb00'
local blue           = '#00bb00'
local yellow         = '#005500'
local orange         = '#00bb00'
...
local cyan           = '#00bb00'
local fg             = '#00bb00'
local fg_light       = '#00bb00'
local fg_dark        = '#007700'
local hollow         = '#00bb00'
local hollow_lighter = '#00bb00'
local white          = '#00bb00'
...
local editor_syntax = {
    ...
    ColorColumn  = { fg = yellow, bg = bg_light },
    NumberColumn  = { fg = yellow, bg = bg_light },
    SignColumn   = { fg = yellow },
    IncSearch    = { bg = yellow, fg = bg },
    Substitute   = { bg = blue, fg = bg },
    LineNr       = { fg = fg_dark, bg = bg_light },
    CursorLineNr = { fg = fg },
